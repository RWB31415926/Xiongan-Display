    ...
    function ceshis2() {
        ...
        option = {
                    ...
                    legend : {
                        ...
                        data: ['(0,100]', '(100,500]', '(500,1000]', '>1000']
                        },
                    series: [
                        {
                        type: 'pie',
                        ...
                        data: [
                            { name: '(0,100]', value: 50 },
                            { name: '(100,500]', value: 26 },
                            { name: '(500,1000]', value: 24 },
                            { name: '>1000', value: 12 }
                        ]
                        },
                        {
    ...
    function ceshis3() {
        ...
        option = {
            ...
            series: [{
                name: '机动车量',
                type: 'bar',
                data: [12.0, 4.9, 7.0, 43.2, 175.6, 146.7, 135.6, 122.2, 132.6, 220.0, 46.4, 23.3],
                itemStyle: {
                    normal: {
                        barBorderRadius: 2
                    }
            ...
            },
                {
                    ...
                    type: 'bar',
                    yAxisIndex: 1,
                    data: [6, 5.7, 6.0, 39.6, 163.8,128.1, 122.8, 110.6, 127.8, 150.0,31.2, 15.9],
                    itemStyle: {
                        normal: {
                            barBorderRadius: 2
                        }
                ...
                },
                {
                    ...
                    type: 'line',
                    yAxisIndex: 2,
                    data: [60, 80, 76, 65, 32, 40, 41, 49, 52, 32, 58, 62],
                }
            ]
        };
        // 使用刚指定的配置项和数据显示图表。
